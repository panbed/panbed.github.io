...
export default function Home( {headerTitle, setHeaderTitle } ) {
  ...
  return (
    <>
      <main className='home'>
        <figure>
          <img src='https://avatars.githubusercontent.com/u/106042766?v=4' width={250} alt='My profile picture from GitHub'/>
        ...
        <ul className='links'>
          ...
          <li><a href='files/resume.pdf'><ion-icon name="document-text"></ion-icon>Resume</a></li>
